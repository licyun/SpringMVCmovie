...
function ckstyle() { //定义总的风格
    var ck = {
        ...
        advmarquee: escape('{font color="#FFFFFF" size="12"}注意啊！！由于点播技术限制，不定期出现播放失败的情况，这很正常！请淡定，不要躁动。有时候加载失败，请刷新重试就好，如果还是不行，请切换其他播放方式，实在不行请使用百度云地址，迅雷边下边看或者播放器播放。感觉好用，请分享我们的网站 迅雷影院 www.xunleiyy.com 给小伙伴们啊~啊~啊~~~~{/font}'),
